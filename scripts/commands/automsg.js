...
const nam = [{
    ...
    message: ['~এখন সকাল ৬টা বাজে ঘুম থেকে উঠো সবাই  ']
						 ...
						 {
    timer: '8:00:00 AM',
    message: ['~এখন সকাল ৭টা বাজে সবাই ব্রেকফাস্ট করে নাও ওহ সরি এখন তো রোজার মাস😊 ']
},
						 {
    timer: '9:00:00 AM',
    ...
    message: ['~এখন দুপুর ১টা বাজে সবাই কাজ বন্ধ করে জোহরের নামাজ পড়ে নাও😻 ']
						 ...
						 {
    timer: '3:00:00 PM',
    message: ['~এখন দুপুর ২টা বাজে গোসল করে সবাই কুরআন পড়ো রোজার মাস একে ৭০ ☺️']
},
						 {
    timer: '4:00:00 PM',
    ...
    message: ['~এখন বিকাল ৫টা বাজে একটু পর মাগরিবের আযান দিবে সবাই নামাজ পড়ে নিও 😻']
						 ...
						 {
    timer: '7:00:00 PM',
    message: ['~এখন সন্ধ্যা ৬টা বাজে সবাই হাতমুখ ধুয়ে ইফতারি করে নাও😍. ']
},
             {
    timer: '8:00:00 PM',
    message: ['এখন সন্ধ্যা ৭ টা বাজে কি করছো সবাই একটুপর এশার আযান দিবে সবাই নামাজ পড়ে নাও তারাবী পড়তে ভুইলো না❤️']
},
             {
    timer: '9:00:00 PM',
    message: ['~এখন রাত ৮টা বাজে নামাজে গেছো তো সবাই']
},
             {
    timer: '10:00:00 PM',
